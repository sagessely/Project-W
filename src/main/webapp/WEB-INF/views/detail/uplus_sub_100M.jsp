...
<body>
	...
	<div class="mx-auto" style="width: 85%;">
		<img src="/img/uplus/uplus_top_2.PNG"> <br>
		<hr>
		<br>
		<h3>이용 요금</h3>
		<br>
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					...
					<td class="align-middle text-center"><font color="gray"><del>38,500원</del></font>-><br>
						<font color="red">36,300원</font></td>
					<td class="align-middle text-center"><font color="gray"><del>33,000원</del></font>-><br>
						<font color="red">30,800원</font></td>
				...
				<tr>
					...
					<td class="align-middle text-center"><font color="gray"><del>33,000원</del></font>-><br>
						<font color="red">31,350원</font></td>
					<td class="align-middle text-center"><font color="gray"><del>27,500원</del></font>-><br>
						<font color="red">25,850원</font></td>
					<td class="align-middle text-center">현금 최대 <font color="red">★★만원</font>
						지원 + a
					</td>
				</tr>
				<tr class="table-primary">
					...
					<td class="align-middle text-center"><font color="gray"><del>22,000원</del></font>-><br>
						<font color="red">20,900원</font></td>
					<td class="align-middle text-center"><font color="gray"><del>27,500원</del></font>-><br>
						<font color="red">25,850원</font></td>
					<td class="align-middle text-center">현금 최대 <font color="red">★★만원</font>
						지원 + a
