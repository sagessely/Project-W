...
<meta charset="UTF-8">
<title>윈앤윈</title>
<link rel="stylesheet" href="/resouces/css/bootstrap/bootstrap.css">
</head>
<body>
	...
	<div class="mx-auto" style="width: 85%;">
			...
			<tbody>
				<tr class="table-primary">
					<th class="align-middle text-center" scope="row">기가인터넷 <br>최대
						1G <font color="red"><b>(선택 상품)</b></font></th>
			...
			<tbody>
				<tr class="table-primary">
					<td class="align-middle text-center" scope="row" rowspan="3">기가
						인터넷<br> <font color="red">(선택 상품)</font>
					</td>
		...
		<table class="table table-bordered">
			<thead class="thead-light">
				<tr>
					<th class="align-middle text-center" scope="col" rowspan="2">구분</th>
					<th class="align-middle text-center" scope="col" colspan="7">추가
						결합 시 할인 요금</th>
				</tr>
				<tr>
					...
					<th class="align-middle text-center" scope="col" colspan="2">인터넷
						전화</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="align-middle text-center" scope="row" rowspan="2">기가인터넷
						최대 1G<br>기가인터넷 최대 500M
					</td>
					<td class="align-middle text-center">기가 인터넷<br>+모바일
					</td>
					<td class="align-middle text-center">올레 인터넷+모바일<br>(17.9.1일
						이전<br>올레 인터넷 가입고객)
					</td>
		...
		<br>
		<h3>유의사항</h3>
		최대 속도는 설치장소의 통신설비, 단말 등에 따라 실제 속도와 다를 수 있습니다.<br> 데이터 사용은 무제한이나,
		일 150GByte 초과 시에는 당일에 한해 최대 100Mbps 속도로 제공합니다. (단, IPTV, 인터넷전화의 사용량은
		제외됩니다.)<br> PC 랜카드, 노트북 네트워크 카드 등이 기가 인터넷을 지원하는 경우에만 정상적인 속도로
		서비스를 제공받을 수 있습니다.<br> 약정기간 내 해지한 경우, 사용기간에 따라 서비스 이용료와 장비(모뎀)임대료에
		대한 할인반환금이 부과됩니다.<br> <br> <br>
	</div>
